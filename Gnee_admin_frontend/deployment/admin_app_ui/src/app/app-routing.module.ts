...
import { SubscriptionPackageComponent } from './components/subscription/subscription-package/subscription-package.component';
import { SubscriptionPackageDetailsComponent } from './components/subscription/subscription-package-details/subscription-package-details.component';
import { CurrencyComponent } from './components/subscription/currency/currency.component';
import { CurrencyDetailsComponent } from './components/subscription/currency-details/currency-details.component';
...
const routes: Routes = [
  ...
  { path: 'administrator/subscription/subscription-package', component: SubscriptionPackageComponent,canActivate:[AuthGuard]},
  { path: 'administrator/subscription/currency', component: CurrencyComponent,canActivate:[AuthGuard]},
  ...
  { path: 'administrator/subscription/subscription-package/details/:id/:mode', component: SubscriptionPackageDetailsComponent,canActivate:[AuthGuard]},
  { path: 'administrator/subscription/subscription-package/details/:mode', component: SubscriptionPackageDetailsComponent  ,canActivate:[AuthGuard]},
  { path: 'administrator/subscription/currency/details/:id/:mode', component: CurrencyDetailsComponent,canActivate:[AuthGuard]},
  { path: 'administrator/subscription/currency/details/:mode', component: CurrencyDetailsComponent  ,canActivate:[AuthGuard]},
